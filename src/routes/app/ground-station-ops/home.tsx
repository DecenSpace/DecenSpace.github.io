...
const Home: React.FC = () => {
    ...
    const { groundStations } = useUserGroundStations();

    const activeCount = groundStations.filter((groundStation) => !!groundStation.operationStatus.active).length;
    ...
    return (
        <>
            ...
            <AppContentGrid>
                <DashboardCard>
                    <CardHeader title="Stations" subheader={`${activeCount}/${groundStations.length} active`} />
                    <CardContent>
                    ...
                    <CardActions>
                        <DashboardCardButton component={Link} to="/app/ground-station-ops/stations">
                            View more
                        </DashboardCardButton>
                ...
                <DashboardCard>
                    ...
                    <CardActions>
                        <DashboardCardButton component={Link} to="/app/ground-station-ops/transmissions">
                            View more
                        </DashboardCardButton>
                    </CardActions>
                </DashboardCard>
