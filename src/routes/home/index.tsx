            ...
            <Box component="header" gridArea={GridArea.head}>
                ...
                <Box marginRight={{ xs: 0, sm: 6 }}>
                    <Typography variant="h4">
                        Bringing satellite companies and ground station operators together using distributed marketplace technology.
            ...
            <Box gridArea={GridArea.main} paddingTop={{ xs: 8, sm: 16 }}>
                <TextSection heading="Why we built it" first>
                    <Typography variant="body1">
                        The space industry faces a critical infrastructure challenge: ground station access is expensive, bottlenecked, and inefficient. Satellite operators struggle with limited coverage while existing ground stations sit underutilized. We built Decen Space to create a marketplace that transforms how the space industry communicates with satellites, democratizing access while rewarding participation.
                    </Typography>
                ...
                <TextSection heading="How Decentralized Infrastructure can help">
                    <Typography variant="body1">
                        Decentralized Physical Infrastructure Networks enable secure, transparent, and trustless coordination between satellite operators and ground station owners. We can automate everything from scheduling, payment, and quality verification without middlemen. This creates a self-sustaining network where participants are fairly rewarded for their contributions, while cryptographic verification ensures reliable service quality.
                    </Typography>
