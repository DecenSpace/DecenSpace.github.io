            ...
            <div>
              ...
              <Card variant="outlined" sx={{ marginBottom: 3 }}>
                ...
                >
                  ...
                  <Button color="secondary" startIcon={<InboxIcon />}>
                    Secondary button
                  </Button>
            ...
            <div>
              ...
              <Stack spacing={2} sx={{ maxWidth: 600 }}>
                <SnackbarContent
                  ...
                  action={<Button size="small">lorem ipsum dolorem</Button>}
                />
                ...
                <Alert onClose={() => {}} severity="warning" variant="outlined">
                  This is a warning Alert
                </Alert>
                <Alert onClose={() => {}} severity="success" variant="filled">
                  This is a success Alert
                </Alert>
                <Alert onClose={() => {}} severity="error" variant="filled">
                  This is a error Alert
                </Alert>
                <Alert onClose={() => {}} severity="warning" variant="filled">
                  This is a warning Alert
                </Alert>
              </Stack>
              <Box
              ...
              <Box marginTop={4}>
                ...
                <Typography variant="body1" marginBottom={2}>
                  ...
                  <Link href="#">critical infrastructure</Link> challenge:
                  ground station access is expensive, centralized, and
                  inefficient. Satellite operators struggle with limited
                  coverage while existing ground stations sit underutilized. We
                  built Decen Space to create a marketplace that transforms how
                  the space industry communicates with satellites, democratizing
                  access while rewarding participation.
                </Typography>
