import { styled, Theme, type Typography as MuiTypography } from "@mui/system";
...
const TypographyBase = styled("span", { skipVariantsResolver: true })<{ variant: TypographyVariants }>(({ variant, theme }) => ({
    ...
    marginTop: 0,
    ...((theme.typography && (variant in theme.typography)) ? theme.typography![variant as keyof MuiTypography] as {} : {})
}));
