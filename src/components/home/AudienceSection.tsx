  ...
  <Section>
    ...
    <Box
      sx={{
        ...
        alignItems: "center",
        gap: 'clamp(2rem, 4vw, 5rem)', // Mobile-friendly gap
        maxWidth: "none", // Remove fixed max width
        width: 'clamp(100%, 85vw, 90%)', // Mobile-friendly width
        mx: "auto",
      }}
    >
      <EnumerationItem
      ...
      <EnumerationItem
        ...
        linkLabel="Get in touch with us" href="mailto:groundstation@decenspace.com"
        sx={{
          flexShrink: 0,
          fontFamily: "Satoshi",
          flex: 1,
