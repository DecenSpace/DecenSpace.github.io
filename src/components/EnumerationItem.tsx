...
const OuterCircle = styled("a")(({ theme }) => ({
  ...
  padding:
    "var(--button-padding) clamp(20px, 5vw, 45px) var(--button-padding) calc(var(--button-height) + var(--button-gap))",
  gap: "var(--button-gap)",
  background:
  ...
  <OuterCircle {...props}>
    <InnerCircle>
      ...
      <Typography
        ...
        sx={{
          margin: 0,
          color: "#F5F5F5",
          fontSize: "calc(var(--button-height) * 1)",
          fontWeight: "400",
          lineHeight: "1.2",
    ...
    <SvgIcon
      ...
      sx={{
        ...
        right: "calc(var(--button-padding) * 2)", // Position from the right edge
        color: "#F5F5F5",
